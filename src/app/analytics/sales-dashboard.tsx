...
export default function SalesDashboard() {
  ...
  return (
    <div className="space-y-8">
                          ...
                          >
                            ...
                            <td className="px-6 py-4 text-right font-black text-white tracking-tight">
                              <div className="flex flex-col items-end">
                                ...
                                {["RAPPI", "PEYA", "MERCADOPAGO"].includes(
                                  sale.channel,
                                ) && (
                                  <span className="text-[10px] text-red-500/70 font-bold">
                                    Neto: $
                                    {(
                                      Number(sale.total) * 0.65
                                    ).toLocaleString()}
                                  </span>
                                )}
                              </div>
      ...
      >
        <DialogContent className="bg-[#111] border border-white/10 text-white max-w-lg shadow-2xl p-0 overflow-hidden sm:rounded-3xl">
                ...
                <div className="flex flex-col items-end">
                  ...
                  {["RAPPI", "PEYA", "MERCADOPAGO"].includes(
                    ...
                    <span className="text-xs text-red-500 font-bold uppercase tracking-tighter">
                      Neto (S/ Comisión): $
                      {(Number(selectedSale.total) * 0.65).toLocaleString()}
                    </span>
                  )}
                </div>
              </div>
