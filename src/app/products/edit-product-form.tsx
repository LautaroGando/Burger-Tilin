...
export default function EditProductForm({
  ...
  async function onSubmit(data: ProductFormValues) {
    ...
    if (result.success) {
      ...
      // Auto-reload to refresh ProductList state if no onSuccess is provided
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full h-11 bg-zinc-900/50 border border-white/10 rounded-xl pl-10 pr-4 text-sm font-bold text-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all appearance-none"
                >
